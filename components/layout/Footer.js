        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex bg-parchment/10 rounded-full p-1 border border-parchment/10">
              ...
              />
              <button className="bg-moss text-parchment px-4 py-2 rounded-full text-[10px] font-bold uppercase tracking-widest hover:bg-parchment hover:text-ink transition-colors">
                Join
              </button>
            </div>
          </div>
